...
def save_data_to_files(method, seed_number, app, h ,global_p, phv_record, time_record, link_record, node_record, init_random):
    ...
    with open(method+'/seed'+str(seed_number)+'_'+'init'+str(init_random)+'_'+method+'_iter_time_phv_'+app+'3.csv', 'a+') as f:
...
def save_design_to_files(method, seed_number, app, h ,global_p, phv_record, time_record, link_record, node_record, init_random):
    if not os.path.isdir(method+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'/'):
        os.makedirs(method+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'/')

    with open(method+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'_ar.csv', 'w') as f:
    ...
    for j in link_record:
        with open(method+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_link_iter'+str(h)+'_set'+str(set_count)+'.csv', 'w') as f:
            np.savetxt(f, j, fmt='%i', delimiter=',')
        set_count+=1

    set_count = 0
    for z in node_record:
        with open(method+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_iter'+str(h)+'/seed'+str(seed_number)+'_init'+str(init_random)+'_'+method+'_'+app+'3_node_iter'+str(h)+'_set'+str(set_count)+'.csv', 'w') as f:
...
def initilize_files(method, seed_number, app, init_random):
    ...
    with open(method+'/seed'+str(seed_number)+'_'+'init'+str(init_random)+'_'+method+'_iter_time_phv_'+app+'3.csv', 'w') as f:
